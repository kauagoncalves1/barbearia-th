export default function QuemSomos() {
  return (
    <section id="quemsomos" style={{ padding: '100px 40px', backgroundColor: '#111' }}>
      ...
      <div style={{
        ...
        <div style={{
          ...
          <p style={{ color: '#aaa', fontSize: '16px', lineHeight: '1.9', marginBottom: '24px' }}>
          ...
          <p style={{ color: '#aaa', fontSize: '16px', lineHeight: '1.9', marginBottom: '40px' }}>
          ...
          <div style={{ display: 'flex', gap: '48px', flexWrap: 'wrap' }}>
            <div>
              ...
              <p style={{ color: '#666', fontSize: '13px', letterSpacing: '2px' }}>ANOS DE EXPERIENCIA</p>
            </div>
            <div>
              <p style={{ fontSize: '36px', fontWeight: '900', color: '#c9a84c' }}>100%</p>
              <p style={{ color: '#666', fontSize: '13px', letterSpacing: '2px' }}>DEDICACAO</p>
            </div>
          </div>
        </div>
